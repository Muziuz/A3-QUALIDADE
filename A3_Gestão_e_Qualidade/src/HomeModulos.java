...
public class HomeModulos extends JFrame {
	...
	public HomeModulos() {
		...
		JLabel lblNewJgoodiesTitle = DefaultComponentFactory.getInstance().createTitle("PADARIA");
		...
		JLabel lblNewJgoodiesTitle_1 = DefaultComponentFactory.getInstance().createTitle("DO");
		...
		JLabel lblNewJgoodiesTitle_2 = DefaultComponentFactory.getInstance().createTitle("PADOCA");
